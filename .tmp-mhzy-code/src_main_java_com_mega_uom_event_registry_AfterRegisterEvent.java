package com.mega.uom.event.registry;
...
public class AfterRegisterEvent extends Event implements IModBusEvent {
    @Nullable
    ...
    public AfterRegisterEvent(@NotNull ResourceKey<? extends Registry<?>> registryKey, @Nullable ForgeRegistry<?> forgeRegistry, @Nullable Registry<?> vanillaRegistry) {
