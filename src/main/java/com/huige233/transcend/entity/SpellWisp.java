...
public class SpellWisp extends PathfinderMob {
    ...
    private final RandomSource visualRandom = RandomSource.create();
    ...
    public void tick() {
        ...
        if (this.level() instanceof ServerLevel sl) {
            ...
            if ((this.tickCount & 1) == 0) {
                ...
                ServerVisualBroadcaster.circle(sl, center, radius, r, g, b, 10, 16, "hexagram");
            }
            if (this.tickCount % 3 == 0) {
                Vec3 sparkFrom = center.add(
                        (visualRandom.nextDouble() - 0.5) * 0.7,
                        0.2 + visualRandom.nextDouble() * 0.35,
                        (visualRandom.nextDouble() - 0.5) * 0.7);
                ServerVisualBroadcaster.beam(sl, sparkFrom, center, r, g, b, 8, t < 0.5F ? "beam" : "slash");
            }
            if (this.tickCount % 6 == 0) {
                ServerVisualBroadcaster.shieldRipple(sl, center, 0.42F, 0.9F, 0.95F, 1.0F, 8);
            }
        }
