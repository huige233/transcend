    ...
    public static final RegistryObject<CreativeModeTab> TRANSCEND_TAB = CREATIVE_MODE_TABS.register("transcend_tab",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.wand_expert.get());
                        pOutput.accept(ModItems.wand_legendary.get());
                        ...
                        pOutput.accept(ModItems.element_metal.get());
                        pOutput.accept(ModItems.element_wood.get());
                        pOutput.accept(ModItems.element_water.get());
