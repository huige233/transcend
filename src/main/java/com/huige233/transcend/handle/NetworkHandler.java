...
public class NetworkHandler {
    ...
    public static void init(FMLCommonSetupEvent event){
        ...
        CHANNEL.registerMessage(id++, S2CClassResourceSync.class, S2CClassResourceSync::write, S2CClassResourceSync::new, S2CClassResourceSync::run, Optional.of(NetworkDirection.PLAY_TO_CLIENT));

        CHANNEL.registerMessage(id++, S2COpenProgramScreen.class, S2COpenProgramScreen::write, S2COpenProgramScreen::new, S2COpenProgramScreen::run, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        CHANNEL.registerMessage(id++, C2SWandCardEdit.class, C2SWandCardEdit::write, C2SWandCardEdit::new, C2SWandCardEdit::run, Optional.of(NetworkDirection.PLAY_TO_SERVER));
