...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<com.huige233.transcend.block.MeditationCushionBlockEntity>> MEDITATION_CUSHION_BE =
            BLOCK_ENTITIES.register("meditation_cushion_be",
                    () -> BlockEntityType.Builder.of(
                            com.huige233.transcend.block.MeditationCushionBlockEntity::new,
